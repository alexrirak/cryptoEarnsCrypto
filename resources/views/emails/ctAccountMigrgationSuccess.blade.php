                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%"
                            ...
                            <tr>
                                <td style="color: #153643!important; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
                                    <p style="margin: 0px 0px 20px;">This email is being sent to inform you that your Celsius Tracker account has been migrated to {{ config('app.name') }}.</p>

                                    <p style="margin: 0px 0px 20px;">You can access your account and manage your settings via the login page: <a href="{{ route('login') }}" >{{ route('login') }}</a>.</p>

                                    <p style="margin: 0px 0px 20px;">Please add <i><a href="mailto:noreply@cryptoearnscrypto.com">noreply@cryptoearnscrypto.com</a></i> to your address book to ensure receipt of our emails.</p>
