...
class UserRateNotificationSender
{
    ...
    public function handle(UserRateNotification $event)
    {
        ...
        $updatedRates = Rate::join('coin_metadata', 'rates.coin_id', '=', 'coin_metadata.id')
                            ->join('user_notifications', 'rates.coin_id', '=', 'user_notifications.coin_id')
                            ...
                            ->select(
                                ...
                                'rates.source',
                                'user_notifications.use_special'
                            )
                            ...
                            ->groupBy('rates.coin_id', 'rates.source','user_notifications.use_special')
                            ->get();
